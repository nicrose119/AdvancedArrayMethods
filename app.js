...
//Filter
// function getCuisineChoice(dishes){
    
//     let cuisineChoice = prompt("Please select your choice of cuisine") 
//     cuisineChoice = dishes.filter(funtion(el){
//         if(el.cuisine){
//             return true;
//         }
//         else{
...
function getItalianCuisine(dishes) {
    if (dishes.cuisine === "Italian" && dishes.servings >= 5) {
        return true;
    } else {
        return false;
    }
}
let italianCuisine = dishes.filter(getItalianCuisine);
...
function getIdMatchingServings(dishes) {
    if (dishes.id === dishes.servings) {
        return true;
    }   else {
        return false;
    }
}
let idMatchingServings = dishes.filter(getIdMatchingServings);

console.log(idMatchingServings);
...
//Filter
// function getIncludesChickPeas(dishes) {
//     if (dishes.includes(chickpeas)) {
//         return true;
//     }   else {
//         return false;
//     }
// }
// let includesChickPeas = dishes.includes(chickpeas);

// console.log(includesChickPeas)
